...
export async function seedDatabase(): Promise<void> {
  ...
  if (existingStories.length === 0) {
    const stories = [
      { title: "Our Beginning 💕", date: "10th July 2025", description: "The day our story began. Two souls found each other, and everything changed. This is where forever started — a beautiful beginning to the journey we're celebrating with you today.", imageUrl: "https://images.unsplash.com/photo-1518568814500-bf0f8d125f46?w=800&h=600&fit=crop", sortOrder: 1 },
      { title: "Our First Movie 🎬", date: "12th July 2025", description: "Just two days in, and we already knew something special was happening. Our first movie date was less about the film and more about those stolen glances and shared laughter. The best stories don't always happen on screen.", imageUrl: "https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=800&h=600&fit=crop", sortOrder: 2 },
      ...
      { title: "A Birthday at Isha 🎂🕉️", date: "20th November 2025", description: "A special day celebrated apart, yet close at heart. From Isha Foundation came a beautiful blessing — a Shiv ji murti and a promise to visit together soon. Some wishes are meant to be fulfilled together. 🙏", imageUrl: "https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?w=800&h=600&fit=crop", sortOrder: 5 },
      { title: "First Christmas Together 🎄", date: "25th December 2025", description: "Our first holiday season as a couple! An evening in Jollygunj, clinking glasses and making memories. The start of a lifetime of celebrations, laughter, and traditions we'll create together.", imageUrl: "https://images.unsplash.com/photo-1512909006721-3d6018887383?w=800&h=600&fit=crop", sortOrder: 6 },
      ...
      { title: "Laughter & Comedy 😂🎤", date: "18th January 2026", description: "Our first stand-up comedy show together! An evening filled with belly laughs, sore cheeks, and pure joy. Finding someone who makes you laugh until you cry — that's the real magic.", imageUrl: "https://images.unsplash.com/photo-1527224857830-43a7acc85260?w=800&h=600&fit=crop", sortOrder: 8 },
      { title: "Our First Flight Together ✈️💕", date: "23rd January 2026", description: "Taking flight together for the first time — to meet each other's families and take the next step. Nervous excitement, hopeful hearts, and hands held tight. Some journeys change everything.", imageUrl: "https://images.unsplash.com/photo-1464037866556-6812c9d1c72e?w=800&h=600&fit=crop", sortOrder: 9 },
      { title: "Blessed in Siliguri 👨‍👩‍👧‍👦🌄", date: "24th January 2026", description: "A magical trip to Siliguri where both our families came together for the first time. Exploring the hills, sharing stories, and watching our loved ones bond over momos, oranges, and laughter. This is where we received the blessings that brought us here today.", imageUrl: "/IMG-20260303-WA0001.jpg", sortOrder: 10 },
    ];
